...
#define ORIONBOARDCONFIG_H
 ...
 //  MickeyBoardConfig.h - Orion Board Configuration for VE3WMB Mickey prototype Board - U3S Clone
...
atmega328 pin #                                    
	  ...
	  9        PD5 (PCINT21/OC0B/T1)                U3S - si5351a CLK2 
	 ...
	 21        GND
	 22        ADC7
	 23        PCO (ADC0/PCINT8)                    OneWire Bus for DS1820                      Arduino analog input A0
	 24        PC1 (ADC1/PCINT9)					          Unused analog for random number seed		    Arduino analog input A1 
	 
	 25        PC2 (ADC2/PCINT10)
	 26        PC3 (ADC3/PCINT11)                   V+ input to ADC                             Arduino Analog input A3 
	 27        PC4 (ADC4/SDA/PCINT11)
	 28        PC5 (ADC5/SCL/PCINT13)               NEO-M8 GPS pin  3 - time pulse PPS
	 29        PC6 (!RESET/PCINT14)
	 30        PD0 (RXD/PCINT16)                    NEO-M8 GPS pin 20 - TXD
	 31        PD1 (TXD/PCINT17)                    
