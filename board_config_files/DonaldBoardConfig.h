...
#define ORIONBOARDCONFIG_H
 ...
 //  DonaldBoardConfig.h - Orion Board Configuration for VE3WMB Donald Breadboard Protoype - U3S Clone
 //  HW serial to GPS, SW serial for debug monitor, software I2C (Mimics Stella9.1 board)
...
#define BOARDNAME " - Donald"        // This string is output along with code version using the 'v' command in the monitor
...
#define SI5351A_CLK_FREQ_CORRECTION  	0		// Correction factor for Etherkit Si5351a board with TCXO
