...
#define ORIONBOARDCONFIG_H
 ...
 //  PlutoBoardConfig.h - Orion Board Configuration for VE3WMB Pluto Breadboard Protoype
 //  SW serial to GPS, HW serial for debug monitor, Hardware I2C (Mimics K1FM PicoBv1.1 board)
...
#define BOARDNAME " - Pluto"        // This string is output along with code version using the 'v' command in the monitor
...
************************************************************************************************************************/
#define SI5351A_CLK_FREQ_CORRECTION  11291    //Correction Value for VE3WMB Adafruit Si5351 Breakout board (Pluto Prototype)
