...
*/
enum OrionState {POWERUP_ST, WAIT_CALIBRATE_ST, CALIBRATE_ST, WAIT_TELEMETRY_ST, TELEMETRY_ST, WAIT_TX_PRIMARY_WSPR_ST, 
                 TX_PRIMARY_WSPR_ST, WAIT_TX_SECONDARY_WSPR_ST, TX_SECONDARY_WSPR_ST};
                 
enum OrionEvent {NO_EV,SETUP_DONE_EV, CALIBRATION_TIME_EV, CALIBRATION_DONE_EV, TELEMETRY_TIME_EV, TELEMETRY_DONE_EV,
                 PRIMARY_WSPR_TX_TIME_EV, PRIMARY_WSPR_TX_DONE_EV, SECONDARY_WSPR_TX_TIME_EV, SECONDARY_WSPR_TX_DONE_EV};

enum OrionAction {NO_ACTION,DO_CALIBRATION_ACTION, GET_TELEMETRY_ACTION, TX_WSPR_MSG1_ACTION, TX_WSPR_MSG2_ACTION}; 
